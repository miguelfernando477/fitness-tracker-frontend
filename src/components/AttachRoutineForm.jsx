...
const AttachRoutineForm = () => {
  ...
  return (
    <div className="formContainer">
      ...
      >
        <h1 className="pageTitle" id="addActivityTitle">
          Add Activity to
        </h1>
        <h1 className="pageTitle" id="addActivityTitle2">
          {location.state.name}:
        </h1>
        <label className="formLabel">
          ...
          >
            <option value="selectactivity" hidden disabled>
              Select Activity
            </option>
